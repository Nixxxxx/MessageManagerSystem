...
public class BookManageInterFrameOthers extends JInternalFrame {
	private DbUtil dbUtil=new DbUtil();
	
	private JTextField bookSearchTxt;
	...
	private JComboBox bookTypeSearchTxt;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					BookManageInterFrameOthers frame = new BookManageInterFrameOthers();
	 ...
	 * Create the frame.
	 */
	public BookManageInterFrameOthers() {
		setTitle("\u56FE\u4E66\u7BA1\u7406");
		setClosable(true);
		setIconifiable(true);
		setBounds(100, 100, 803, 795);
		
		JLabel label = new JLabel("\u56FE\u4E66\u540D\u79F0\uFF1A");
		
		bookSearchTxt = new JTextField();
		bookSearchTxt.setColumns(10);
		...
		bookTypeSearchTxt = new JComboBox();
		...
		btnNewButton.setIcon(new ImageIcon(BookManageInterFrameOthers.class.getResource("/images/search.png")));
				...
				.addGroup(Alignment.TRAILING, groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.TRAILING)
						...
						.addGroup(Alignment.LEADING, groupLayout.createSequentialGroup()
							...
							.addComponent(bookSearchTxt, GroupLayout.PREFERRED_SIZE, 126, GroupLayout.PREFERRED_SIZE)
							.addGap(18)
							.addComponent(lblNewLabel)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(authorSearchTxt, GroupLayout.PREFERRED_SIZE, 72, GroupLayout.PREFERRED_SIZE)
							.addGap(26)
							.addComponent(label_1)
							.addPreferredGap(ComponentPlacement.RELATED)
							.addComponent(bookTypeSearchTxt, 0, 103, Short.MAX_VALUE)
							.addGap(18)
			...
			groupLayout.createParallelGroup(Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(Alignment.BASELINE)
						.addComponent(label)
						.addComponent(bookSearchTxt, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(bookTypeSearchTxt, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnNewButton)
						.addComponent(label_1)
		...
		btnNewButton_1.setIcon(new ImageIcon(BookManageInterFrameOthers.class.getResource("/images/modify.png")));
		...
		button.setIcon(new ImageIcon(BookManageInterFrameOthers.class.getResource("/images/delete.png")));
	...
	private void search(String type) {
		...
		dtm.setRowCount(0);
		Book book=null;
		if(bookTypeSearchTxt.getSelectedItem()=="请选择...") {
			book=new Book(bookSearchTxt.getText(),authorSearchTxt.getText(),0);
		}else{
			BookType bookType=(BookType) bookTypeSearchTxt.getSelectedItem();
			int bookTypeId=bookType.getId();
			book=new Book(bookSearchTxt.getText(),authorSearchTxt.getText(),bookTypeId);
		}
		resetValues();
		Connection con=null;
		try {
	...
	private void fillBookType(String type){
		...
		try {
			...
			while(rs.next()){
				...
				if(type=="top") bookTypeSearchTxt.addItem(bookType);
				if(type=="low")	{
