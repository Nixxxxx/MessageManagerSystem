...
public class BookManageInterFrame extends JInternalFrame {
	...
	public BookManageInterFrame() {
		...
		btnNewButton.setIcon(new ImageIcon(BookManageInterFrame.class.getResource("/images/search.png")));
		...
		btnNewButton_1.setIcon(new ImageIcon(BookManageInterFrame.class.getResource("/images/modify.png")));
		...
		button.setIcon(new ImageIcon(BookManageInterFrame.class.getResource("/images/delete.png")));
		...
		table.setModel(new DefaultTableModel(
			...
			new String[] {
				"\u7F16\u53F7", "\u56FE\u4E66\u540D\u79F0", "\u4F5C\u8005", "\u6027\u522B", "\u4EF7\u683C", "\u51FA\u7248\u793E", "\u56FE\u4E66\u63CF\u8FF0", "\u56FE\u4E66\u7C7B\u578B"
			}
		));
